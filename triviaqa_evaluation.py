...
if __name__ == '__main__':
    ...
    dataset_file = "/hy-tmp/qa/verified-web-dev.json"
    # prediction_file每次都修改一下
    prediction_file = "/hy-tmp/MiniCPM/finetune/output/LoRA/20240731032141/checkpoint-1000/predictions_tri.json"

    dataset_json = utils.dataset_utils.read_triviaqa_data(dataset_file)
    ...
    predictions = utils.utils.read_json(prediction_file)
